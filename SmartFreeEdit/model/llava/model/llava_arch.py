...
from SmartFreeEdit.utils.utils_lisa import (DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN,
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if vision_tower is None or images is None or input_ids.shape[1] == 1:
            if (
                ...
                if past_key_values is not None and len(past_key_values) > 0 and len(past_key_values[-1]) > 0:
                    attention_mask = torch.ones(
